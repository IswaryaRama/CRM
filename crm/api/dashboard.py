...
def get_dashboard(from_date: str | None = None, to_date: str | None = None, user: str | None = None):
	...
	is_sales_user = "Sales User" in roles and not is_sales_manager and not is_system_manager
	...
	if is_system_manager:
		...
		if enable_hierarchy:
			...
			if user and user not in allowed:
				frappe.throw(_("Not permitted to view this user's dashboard"), frappe.PermissionError)
		else:
