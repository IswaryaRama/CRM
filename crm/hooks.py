app_name = "crm"
app_title = "AIProf CRM"
app_publisher = "AIProf Technologies Pvt. Ltd."
...
doc_events = {
	...
	"ToDo": {
		"validate": ["crm.permissions.assignment_validation.validate_assignment"],
...
after_migrate = [
	...
	"crm.install.add_user_reports_to_custom_field",
]
